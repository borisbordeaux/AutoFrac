...
constraint("B4", { "p0", "b0" }, { "b1" })
constraint("B4", { "p0", "intern_0" }, { "intern_0" })
constraint("B4", { "p0", "b1" }, { "b0" })
constraint("B4", { "p0", "s0" }, { "s3", "p0" })
constraint("B4", { "p0", "s1" }, { "s2", "p0" })
constraint("B4", { "p0", "s2" }, { "s1", "p0" })
constraint("B4", { "p0", "s3" }, { "s0", "p0" })
initMat("B4", "s0", {
...
constraint("Cell_0", { "b0", "s2", "p0" }, { "s1", "b2" })
constraint("Cell_0", { "b0", "s2", "p0" }, { "s1", "b2" })
constraint("Cell_0", { "b0", "s3", "p0" }, { "s11", "b1" })
constraint("Cell_0", { "b0", "s0", "p0" }, { "s15", "b0" })
constraint("Cell_0", { "b0", "s1", "p0" }, { "s16", "b2" })
constraint("Cell_0", { "b1", "s2", "p0" }, { "s0", "b1" })
constraint("Cell_0", { "b1", "s3", "p0" }, { "s7", "b1" })
constraint("Cell_0", { "b1", "s0", "p0" }, { "s11", "b0" })
constraint("Cell_0", { "b1", "s1", "p0" }, { "s12", "b2" })
constraint("Cell_0", { "b2", "s2", "p0" }, { "s3", "b0" })
constraint("Cell_0", { "b2", "s0", "p0" }, { "s7", "b0" })
constraint("Cell_0", { "b2", "s1", "p0" }, { "s8", "b2" })
constraint("Cell_0", { "b2", "s3", "p0" }, { "s15", "b1" })
