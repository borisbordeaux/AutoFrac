...
constraint("L", { "permut", "s0" }, { "s0", "permut" })
...
constraint("WB", { "b2", "s0" }, { "s1", "b2" })
constraint("WB", { "b2", "s1" }, { "s0", "b2" })
constraint("WB", { "b3", "s0" }, { "s0", "b3" })

constraint("WC", { "b0", "s0" }, { "s0", "b0" })
constraint("WC", { "b0", "s1" }, { "s1", "b0" })
constraint("WC", { "b1", "s0" }, { "s1", "b1" })
constraint("WC", { "b2", "s0" }, { "s1", "b2" })
constraint("WC", { "b2", "s1" }, { "s0", "b2" })
constraint("WC", { "b3", "s0" }, { "s0", "b3" })
-- on volume
...
constraint("Vol", { "b1", "s0" }, { "s0", "b1" })
constraint("Vol", { "b1", "s1" }, { "s1", "b1" })
constraint("Vol", { "b1", "s2" }, { "s2", "b1" })
constraint("Vol", { "b1", "s3" }, { "s3", "b1" })
constraint("Vol", { "b1", "s4" }, { "s4", "b1" })
constraint("Vol", { "b1", "s5" }, { "s5", "b1" })
