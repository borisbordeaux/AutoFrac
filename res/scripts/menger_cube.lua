...
initMat("init", { "s0" }, {
    { -0.5 * f, -0.5 * f,  0.5 * f,  0.5 * f,  0.5 * f,  0.5 * f, -0.5 * f, -0.5 * f },
    {  0.5 * f, -0.5 * f, -0.5 * f,  0.5 * f, -0.5 * f,  0.5 * f,  0.5 * f, -0.5 * f },
    {  0.5 * f,  0.5 * f,  0.5 * f,  0.5 * f, -0.5 * f, -0.5 * f, -0.5 * f, -0.5 * f }
}, "VAR")

-- subdivision("s1", "init", "C")
-- local s = 4
-- initMat("init", "s1", {
--     { -0.5 * f + s, -0.5 * f + s,  0.5 * f + s,  0.5 * f + s,  0.5 * f + s,  0.5 * f + s, -0.5 * f + s, -0.5 * f + s },
--     {  0.5 * f, -0.5 * f, -0.5 * f,  0.5 * f, -0.5 * f,  0.5 * f,  0.5 * f, -0.5 * f },
--     {  0.5 * f,  0.5 * f,  0.5 * f,  0.5 * f, -0.5 * f, -0.5 * f, -0.5 * f, -0.5 * f }
-- }, "VAR")
-- constraint("init", { "s0", "b1", "p0", "r0", "r0" }, { "s1", "b3" })